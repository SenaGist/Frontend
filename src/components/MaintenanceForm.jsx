...
export const MaintenanceForm = ({ handleModal, dialogRef, userId, setMaintenances, apiUrl }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        const requiredFields = ["type", "maintenance_description"];
    ...
    return (
        <dialog ref={dialogRef} id="favDialog">
            ...
            <form className="form" onSubmit={handleSubmit}>
                    ...
                    <fieldset>
                        ...
                        <div className="field-group">
                            <label>
                                ...
                                <input type="number" name="inventoryNumber" required onChange={handleChange} />
                            </label>
                ...
                {comprobate && existingAsset === null && (
                    <>
                        <fieldset>
                            <legend>Detalles del Activo (Nuevo)</legend>
                            <div className="field-group">
                                <label>Número de Inventario:
                                    <input type="text" name="inventoryNumber" required value={inventoryNumber} readOnly />
                                </label>
                                <label>Ubicación:<input type="text" name="location" required /></label>
                                <label>Marca:<input type="text" name="brand" required /></label>
                                <label>Modelo:<input type="text" name="model" required /></label>
                                <label>
                                    Tipo:
                                    <select name="asset_type" onChange={handleType} required>
                ...
                {comprobate && (
                    <fieldset>
                        ...
                        <label>Descripción:<textarea name="maintenance_description" required /></label>
